...
complete -c ctest -l tests-from-file -d 'New in version 3. 29.  Run tests listed in the given file'
complete -c ctest -l exclude-from-file -d 'New in version 3. 29.  Exclude tests listed in the given file'
...
complete -c ctest -l test-dir -d 'New in version 3. 20'
...
complete -c ctest -l http-header -d 'New in version 3. 29.  Append HTTP header when submitting to the dashboard'
